...
<button class="button" data-filter=".instream-index">in-stream habitat</button>
<button class="button" data-filter=".species-index">species</button>
</div>
</div>

<div class="ui-group"><h4>Variables included in index</h4>
...
<br>
<p><center><button class="button button--reset">Reset filters</button></p></center>
...
// add bit to be able to reset all filters
