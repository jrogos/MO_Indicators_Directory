...
# Potential use ----
# prioritization - identify areas or species for restoration and conservation to address potential environmental stressors
# research - investigate the relationships between potential stressors or indices and aquatic ecosystem integrity or species response
# monitoring - identify potential reference or degraded sites or sensitive species to track through time or in response to an event
# outreach - use maps and recognized potential stressors to educate the public or promote landowner incentive programs
...
<div class="ui-group">  <h4>Data availability</h4>
...
<!-- FishTail -->  
  <div class="grid-item landscape-index landuse barriers water-quality climate-change yes planning research monitoring outreach public">
  ...
  <p class="desc"><span style="color: #cc3366"><b>tags:</b></span> landuse, barriers, water quality, climate change</p>
  <p class="desc"><span style="color: #33cc99"><b>availability:</b></span> web-based map viewer, publicly downloadable datasets </p>
...
<!-- Human Threat Index -->   
  <div class="grid-item landscape-index landuse barriers no planning research monitoring outreach private">
  ...
  <p class="desc"><span style="color: #cc3366"><b>tags:</b></span> landuse, barriers</p>
  <p class="desc"><span style="color: #33cc99"><b>availability:</b></span> public report, private datasets </p>
  ...
  <p class="desc"><span style="color: #ff9933"><b>example:</b></span> MDC biologists identified stressors in watersheds like Hickory Creek using the HTI to help inform whether or not they should be classified as a priority area in regional conservation and management planning.</p>
  <br>
  </div>
 ...
 <!-- Species Vulnerability Index --> 
  ...
  <p class="desc"><span style="color: #cc3366"><b>tags:</b></span> species response attributes </p>
  <p class="desc"><span style="color: #33cc99"><b>availability:</b></span> peer-review publication, appendix table </p>
...
<!-- National Fish Habitat Assessment -->
  <div class="grid-item landscape-index landuse barriers yes planning research monitoring outreach public">
  ...
  <p class="desc"><span style="color: #33cc99"><b>availability:</b></span> web-based report, publicly downloadable datasets </p>
...
<!-- Southeast Aquatic Barrier Prioritization Tool -->
  <div class="grid-item landscape-index landuse connectivity no planning outreach public">
  ...
  <p class="desc"><span style="color: #cc3366"><b>tags:</b></span> land use, barriers </p>
  <p class="desc"><span style="color: #33cc99"><b>availability:</b></span> web-based inventory and prioritization, publicly downloadable datasets</p>
