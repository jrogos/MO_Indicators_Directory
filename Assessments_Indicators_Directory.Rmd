...
```
<center style="text-align: left;"><h3 style="margin-left: 2%;">Filters</h3>
...
<div class="ui-group"><h4>Variable inputs</h4>
...
<div class="ui-group"><h4>Species response incorporated</h4>
...
<!-- National Fish Habitat Assessment -->
  ...
  <p class="desc"><span style="color: #ff9933"><b>example:</b></span> undetermined specific case </p>
  <br>
</div>
...
function concatValues( obj ) {
  ...
  $('.button--reset').on( 'click', function( event ) {
    ...
    //$("#filter-select option:eq(0)").prop('selected', true);
